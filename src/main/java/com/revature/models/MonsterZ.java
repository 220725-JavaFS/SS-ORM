...
public class MonsterZ {
	...
	public MonsterZ(int monsters_id, String name, String attributeType, int attack, int defense, String description) {
		super();
	...
	public MonsterZ(String name, String attributeType, int attack, int defense, String description) {
		super();
		this.name = name;
		this.attributeType = attributeType;
		this.attack = attack;
	...
	public MonsterZ(String name, String attributeType, int attack, int defense) {
		super();
		this.name = name;
		this.attributeType = attributeType;
		this.attack = attack;
